...
readonly container_name="ses-adapter-test-ghost-${run_id}"
readonly image_name="ses-adapter-test-ghost:${run_id}"
readonly temp_dir="$(mktemp -d "${TMPDIR:-/tmp}/ses-adapter-test-XXXXXX")"
